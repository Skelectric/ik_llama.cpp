...
extern "C" {
    ...
    enum ggml_type {
        ...
        // Phase 4 (DeepSeek-V4.1) packed KV-cache storage types. Storage-only:
        // written by ggml_set_rows, read back through ggml_get_rows -> F32.
        // See ggml-kv-quants.h and dsv41-test/docs/phase4-fp4-kv-cache-plan.md.
