...
struct llama_model_loader {
    ...
    llama_expert_tensor_index engram_tensor_index;
    ...
    void build_engram_tensor_index();

    bool should_defer_engram_mmaps() const;

    void apply_engram_mmap_policy() const;
