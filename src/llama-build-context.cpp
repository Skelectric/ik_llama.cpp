...
ggml_cgraph * llm_build_context::build_k_shift() {
    ...
    const float yarn_attn_factor_shift = model.arch == LLM_ARCH_DEEPSEEK2 || model.arch == LLM_ARCH_DEEPSEEK4 || model.arch == LLM_ARCH_DEEPSEEK41 || model.arch == LLM_ARCH_MISTRAL4
