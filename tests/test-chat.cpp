...
static void test_template_output_peg_parsers(bool detailed_debug) {
    ...
    // DeepSeek V4.1 tests - same DSML machinery as V3.2/V4, but the tag names carry a
    // leading space (reference: DeepSeek-V4.1-Flash encoding/README.md). Template is
    // smalinin's V4.1 jinja from llama.cpp PR #28696 (issuecomment-5647447107).
    //   <｜DSML｜ calls>
    //   <｜DSML｜ invoke name="foo">
    //   <｜DSML｜ parameter name="bar" string="true|false">value</｜DSML｜ parameter>
    //   </｜DSML｜ invoke>
    //   </｜DSML｜ calls>
    // Reasoning uses the same thinking delimiters as V3.2/V4. The V4.1 generation
    // prompt ends in the thinking-start token (thinking mode) or a bare thinking-end
    // token (non-thinking mode, like V4).
    {
